...
_G.packer_plugins = {
  ...
  ["transparent.nvim"] = {
    loaded = true,
    path = "/home/aaron/.local/share/nvim/site/pack/packer/start/transparent.nvim",
